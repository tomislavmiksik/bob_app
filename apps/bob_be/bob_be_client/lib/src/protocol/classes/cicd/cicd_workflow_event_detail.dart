...
abstract class CICDWorkflowEventDetail implements _i1.SerializableModel {
  CICDWorkflowEventDetail._({
    this.id,
  ...
  factory CICDWorkflowEventDetail({
    _i1.UuidValue? id,
    ...
    DateTime? updatedAt,
  }) = _CICDWorkflowEventDetailImpl;

  factory CICDWorkflowEventDetail.fromJson(
  ...
  /// Returns a shallow copy of this [CICDWorkflowEventDetail]
  /// with some or all fields replaced by the given arguments.
  @_i1.useResult
  CICDWorkflowEventDetail copyWith({
    _i1.UuidValue? id,
    String? workflowName,
    String? buildId,
    String? branch,
...
class _CICDWorkflowEventDetailImpl extends CICDWorkflowEventDetail {
  _CICDWorkflowEventDetailImpl({
    _i1.UuidValue? id,
    required String workflowName,
    required String buildId,
